          ...
          <div className="flex-grow">
            <div className="px-4 py-6 text-center border-b">
              <h1 className="text-xl font-bold leading-none">
                <span className="text-[#736F6E]">Doctor {doctordetails.doctorName}  cabin</span>
              </h1>
            </div>
            <div className="p-4">
                ...
                <div>
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    ...
                    <div className="p-4 bg-[#E5E4E2] rounded-xl text-gray-800">
                      <div className="font-bold text-2xl leading-none">{doctordetails.surgeries.length}</div>
                      <div className="mt-2">Surgeries</div>
                    </div>
                    <div className="p-4 bg-[#E5E4E2] rounded-xl text-gray-800">
                      <div className="font-bold text-2xl leading-none">{doctordetails.patients.length}</div>
